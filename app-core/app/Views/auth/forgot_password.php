...
<body class="bg-slate-50 min-h-screen flex items-center justify-center p-4">
    <div class="w-full max-w-md bg-white rounded-2xl shadow-xl border border-slate-100 p-8">
        <div class="text-center mb-6">
            ...
            <p class="text-slate-500 text-sm mt-1">Masukkan email akun Anda. Kami kirimkan tautan untuk mengatur password baru.</p>
        </div>
        ...
        <form action="<?= base_url('forgot-password') ?>" method="POST" class="space-y-5">
            ...
            <div class="flex flex-col gap-1.5">
                <label class="text-slate-700 text-sm font-semibold">Email</label>
        ...
        <p class="text-center text-sm text-slate-500 mt-6">
            <a href="<?= base_url('login') ?>" class="text-primary font-bold hover:underline">Kembali ke Login</a>
        </p>
    </div>
</body></html>
